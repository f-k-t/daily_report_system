        ...
        <table id="attendance_list">
            <tbody>
                <tr>
                    ...
                    <th class="attendance_entering">出勤時間</th>
                    <th class="attendance_leaving">退勤時間</th>
                ...
                <c:forEach var="attendance" items="${attendances}" varStatus="status">
                    <tr class="row${status.count % 2}">
                        ...
                        <td class="attendance_entering">${attendance.entering}</td>
                        <td class="attendance_leaving">${attendance.leaving}</td>
